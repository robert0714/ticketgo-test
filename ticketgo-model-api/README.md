...
大賀票卷商品<br/>
使用前要再主機設定<br/>
 /etc/hosts 新增以下DNS對應 (Mac : /private/etc/hosts)<br/>
 52.193.99.98  tms.ticketgo.com.tw<br/>
...
public class TicketGoConvertorTest {
	...
	/** The resource url. */
	final String resourceUrl ="https://tms.ticketgo.com.tw/TKA/login/DHMC_DHMC/api.php";
